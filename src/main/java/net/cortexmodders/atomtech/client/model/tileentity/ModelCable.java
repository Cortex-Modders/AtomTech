...
public class ModelCable extends ModelBase
{
    ...
    public void renderModel(final float f, final boolean top, final boolean bottom, final boolean left, final boolean right, final boolean front, final boolean back)
    {
